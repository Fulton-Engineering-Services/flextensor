...
def test_eager_profiling_budget_uses_full_iters_when_compiled_profile():
    ...
    # ``iters_before_inference`` arithmetic this test pins. With
    # ``skip_discovery=True`` the discovery component drops to zero —
    # the skip variants of ``iters_before_inference`` are covered in
